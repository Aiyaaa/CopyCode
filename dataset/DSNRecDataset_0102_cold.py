...
class DSNRecDataset:
    ...
    def __getUserTrainTest(self):
        df_SrcTrain = pd.read_csv(self.input_dir+'preprocess/sele_data_nocold/%s_%s/uThan%s_iThan%s/fold_%s/src_train.csv'%(self.src_domain,self.tgt_domain,self.u_less,self.i_less,self.fold))
        df_SrcTest = pd.read_csv(self.input_dir+'preprocess/sele_data_nocold/%s_%s/uThan%s_iThan%s/fold_%s/src_test.csv'%(self.src_domain,self.tgt_domain,self.u_less,self.i_less,self.fold))
        df_TgtTrain = pd.read_csv(self.input_dir+'preprocess/sele_data_nocold/%s_%s/uThan%s_iThan%s/fold_%s/tgt_train.csv'%(self.src_domain,self.tgt_domain,self.u_less,self.i_less,self.fold))
        df_TgtTest = pd.read_csv(self.input_dir+'preprocess/sele_data_nocold/%s_%s/uThan%s_iThan%s/fold_%s/tgt_test.csv'%(self.src_domain,self.tgt_domain,self.u_less,self.i_less,self.fold))
